...
print("Ingrese los Mts^2 de Aspas : ")
mts=int(input("mts^2: "))
...
resultado = open("ResultadosExamenFinal.csv","w")
...
resultado.write("fecha, cantidad generada\n")
for x in range(len(lista5)):
    resultado.write(str(lista5[x][0])+","+str(lista5[x][17])+"\n")
